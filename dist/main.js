    ...
    todo(todo) {
        return this.#range.createContextualFragment(
            `<div class="todo">
                ...
                <p class="todo-date">${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate, 'MMM/dd')}</p>
...
class EventCreator {
    ...
    todoEvents(todoNode, todo, project) {
        ...
        todoNode.querySelector('.edit-date').addEventListener('input', (e) => {
            ...
            todoDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate, 'MMM/dd');
        });
...
_dom_loader__WEBPACK_IMPORTED_MODULE_1__["default"].createHomePage(_todo_items__WEBPACK_IMPORTED_MODULE_0__["default"]);
